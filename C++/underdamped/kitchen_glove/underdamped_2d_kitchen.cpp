...
#define printskip       1
vector<double> dtlist ={0.001,0.005,0.01,0.05}; //g++ -o underdam[0.01, 0.14 , 0.195, 0.273, 0.38,0.5,0.8,1. }; //, 0.531, 0.741, 1.034, 1.443, 2.014};

/////////////////////////////////
#define PATH   "/home/s2133976/OneDrive/ExtendedProject/Code/Stepupyourgame/Stepupyourgame/data/C/underdamped/kitchen_2d"
#define d 10
#define b 5

double U(double x, double y){
    double res=(d*x*x+0.001*(y-1)*(y-1))*((x-1)*(x-1)+b*y*y);
    return res;
