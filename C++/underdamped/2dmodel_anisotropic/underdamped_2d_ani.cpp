...
#define printskip       10000
#define PATH   "/home/s2133976/OneDrive/ExtendedProject/Code/Stepupyourgame/Stepupyourgame/data/C/underdamped_2d"
...
{
    double res=(x*x+y*y-1)*(x*x+y*y-1)*s;
    return res;
}
